...
//		- void LL_GPIO_SetOutputPin(GPIO_TypeDef *GPIOx, uint32_t PinMask)           //===== Seta bit

//		- void LL_GPIO_ResetOutputPin(GPIO_TypeDef *GPIOx, uint32_t PinMask)         //===== Reaetira bit

// 		- void LL_GPIO_TogglePin(GPIO_TypeDef *GPIOx, uint32_t PinMask)              //===== invertira bit

//		- uint32_t LL_GPIO_IsOutputPinSet(GPIO_TypeDef *GPIOx, uint32_t PinMask)     //===== preveri stanje bita
